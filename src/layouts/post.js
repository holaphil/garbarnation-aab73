                ...
                <article className="post py-5 py-sm-6 py-md-7">
                    ...
                    <div className="container container--medium">
                        {markdownContent && (
                            ...
                            <iframe frameborder="0" class="juxtapose" width="100%" height="1373.8078052874528" src="https://cdn.knightlab.com/libs/juxtapose/latest/embed/index.html?uid=902f3be4-0424-11ec-abb7-b9a7ff2ee17c"></iframe>
                        )}
                        {!_.isEmpty(tags) && (
